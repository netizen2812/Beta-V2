"""
GCP CLOUD FORGE v32 — Urdu MMS-VITS "The Reconstruction"
=====================================================
FIXES:
- Fixed ValueError in Posterior Encoder unpacking (expects 3 values, not 4).
- Added more robust logging for shapes.
- Reduced epochs to 100 for faster verification.
"""
...
parser.add_argument("--output_dir", default="gs://maulana-urdu-forge-project-ffb3710a/ur_mms_v32")
...
def main():
    ...
    dataset = UrduV32Dataset(args.ur_csv, tokenizer, active_wav_dir)
    ...
    for epoch in range(args.epochs):
        ...
        for i, batch in enumerate(dataloader):
            ...
            with autocast(enabled=(device == "cuda")):
                ...
                # VAE Path - FIXED UNPACKING
                # Transformers VitsPosteriorEncoder returns (z, m, logs)
                res = model.posterior_encoder(spec, mask)
                z, m_q, logs_q = res[0], res[1], res[2]
                
                wav_hat = model.decoder(z * mask, global_conditioning=None) 

                              ...
                              <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
                                ...
                                <div className="flex items-center gap-2 w-full md:w-auto justify-center md:justify-end shrink-0">
                                  <button
                                    ...
                                    className={`flex items-center gap-1.5 px-4 py-2.5 bg-emerald-800/40 hover:bg-emerald-800/60 border border-emerald-700/50 text-white rounded-xl text-xs font-black uppercase tracking-wider transition-all shadow-md ${isAdvisoryLoading ? 'opacity-60 cursor-not-allowed' : ''}`}
                                  >
                                    {isAdvisoryLoading ? (
                                      <>
